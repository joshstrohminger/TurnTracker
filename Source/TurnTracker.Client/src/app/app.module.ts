...
const routes: Routes = [
  ...
  { path: 'activity/:id/taketurn', component: ActivityComponent, canActivate: [AuthGuard], data: {title: 'Take Turn'} },
  { path: 'activity/:id/turn/:turnId', component: ActivityComponent, canActivate: [AuthGuard], data: {title: 'Turn Details'} },
